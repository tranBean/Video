package com.awesome.tranbean.clearedittext.view;
...
import com.awesome.tranbean.clearedittext.R;
...
{
    /** 默认的清除按钮图标资源 */
    private static final int ICON_CLEAR_DEFAULT = R.drawable.ic_clear_custom_normal;
